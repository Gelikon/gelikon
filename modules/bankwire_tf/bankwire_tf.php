...
class BankWire_Tf extends PaymentModule
{
	private $_html = '';
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Bankwire_Tf Tf');
		...
		$this->extra_mail_vars = array(
										'{bankwire_tf_owner}' => Configuration::get('BANK_WIRE_OWNER'),
										'{bankwire_tf_details}' => nl2br(Configuration::get('BANK_WIRE_DETAILS')),
										'{bankwire_tf_address}' => nl2br(Configuration::get('BANK_WIRE_ADDRESS'))
										);
	}
	...
	public function hookPaymentReturn($params)
	{
		...
		if ($state == Configuration::get('PS_OS_BANKWIRE') || $state == Configuration::get('PS_OS_PREPARATION') || $state == Configuration::get('PS_OS_OUTOFSTOCK'))
		{
			$this->smarty->assign(array(
				...
				'bankwire_tfDetails' => Tools::nl2br($this->details),
				'bankwire_tfAddress' => Tools::nl2br($this->address),
				'bankwire_tfOwner' => $this->owner,
				'status' => 'ok',
