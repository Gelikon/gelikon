...
<div class="item" id="smartblogpost-{$post.id_post}">
    <div class="date">{$post.created|date_format:"%Y.%m.%d"}</div>
    <a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}" class="title">{$post.meta_title}</a>
    ...
    <div class="description">
        ...
        <div class="link">
            <a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}" class="arrow-right"></a>
        </div>
    </div>
</div>
