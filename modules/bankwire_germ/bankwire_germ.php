...
class BankWire_Germ extends PaymentModule
{
	private $_html = '';
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Bank wire Germ');
		...
		$this->extra_mail_vars = array(
										'{bankwire_germ_owner}' => Configuration::get('BANK_WIRE_OWNER'),
										'{bankwire_germ_details}' => nl2br(Configuration::get('BANK_WIRE_DETAILS')),
										'{bankwire_germ_address}' => nl2br(Configuration::get('BANK_WIRE_ADDRESS'))
										);
	}
	...
	private function _displayBankWire_Germ()
	{
	...
	public function getContent()
	{
		...
		$this->_html .= $this->_displayBankWire_Germ();
	...
	public function hookPaymentReturn($params)
	{
		...
		if ($state == Configuration::get('PS_OS_BANKWIRE') || $state == Configuration::get('PS_OS_PREPARATION') || $state == Configuration::get('PS_OS_OUTOFSTOCK'))
		{
			$this->smarty->assign(array(
				'total_to_pay' => Tools::displayPrice($params['total_to_pay'], $params['currencyObj'], false),
				'bankwire_germDetails' => Tools::nl2br($this->details),
				'bankwire_germAddress' => Tools::nl2br($this->address),
				'bankwire_germOwner' => $this->owner,
				'status' => 'ok',
