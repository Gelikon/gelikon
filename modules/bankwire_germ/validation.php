...
//$bankwire_germ->validateOrder($cart->id, Configuration::get('_PS_OS_PREPARATION_'), $total, $bankwire_germ->displayName, NULL, array(), (int)$currency->id, false, $customer->secure_key);
