...
class OrderInvoiceCore extends ObjectModel
{
	...
	/**
	* Convert cyrillic names to translit
	*
	* @return string translit product name
	*/
	...
	public function getProducts($products = false, $selectedProducts = false, $selectedQty = false)
	{
		...
		foreach ($products as $row)
		{
			...
			/* check product name encoding */
			//if ($row['product_name'] == "Война и мир") {$row['product_translit_name']="это война и ";} else {$row['product_translit_name']="другое";}
			$row['product_translit_name'] = $this->translit($row['product_name']);
