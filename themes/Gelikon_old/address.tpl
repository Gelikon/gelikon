...
<div class="box">
	...
	<div class="gk-g-wrap">
		...
		{foreach from=$ordered_adr_fields item=field_name}
			{if $field_name eq 'company'}
				<div class="control-row {if isset($errors.company)}error{/if}">
					<div class="control-label"><label for="company">{l s='Company'}</label></div>
					<div class="control-widget">
						...
						{if isset($errors.company)}<div class="signature">{$errors.company}</div>{/if}
					</div>
			...
			{if $field_name eq 'firstname'}
				<div class="control-row {if isset($errors.firstname)}error{/if}">
					<div class="control-label"><label for="firstname">{l s='First name'} <sup>*</sup></label></div>
					<div class="control-widget">
			...
			{if $field_name eq 'lastname'}
				<div class="control-row {if isset($errors.lastname)}error{/if}">
					<div class="control-label"><label for="lastname">{l s='Last name'} <sup>*</sup></label></div>
					<div class="control-widget">
			...
			{if $field_name eq 'address1'}
				<div class="control-row {if isset($errors.address1)}error{/if}">
					<div class="control-label"><label for="address1">{l s='Address'} <sup>*</sup></label></div>
					<div class="control-widget">
						...
						{if isset($errors.address1)}<div class="signature">{$errors.address1}</div>{/if}
					</div>
					<div class="gk-clear-fix"></div>
				</div>
			{/if}
			{if $field_name eq 'address2'}
				<div class="control-row {if isset($errors.address2)}error{/if}">
					<div class="control-label"><label for="address2">{l s='Address (Line 2)'}</label></div>
					<div class="control-widget">
						...
						{if isset($errors.address2)}<div class="signature">{$errors.address2}</div>{/if}
					</div>
					<div class="gk-clear-fix"></div>
				</div>
			{/if}
			{if $field_name eq 'postcode'}
				...
				<div class="control-row {if isset($errors.postcode)}error{/if}">
					<div class="control-label"><label for="postcode">{l s='Zip/Postal Code'} <sup>*</sup></label></div>
					<div class="control-widget">
						<input type="text" id="postcode" name="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{else}{if isset($address->postcode)}{$address->postcode|escape:'html':'UTF-8'}{/if}{/if}" />
						{if isset($errors.postcode)}<div class="signature">{$errors.postcode}</div>{/if}
					</div>
					<div class="gk-clear-fix"></div>
				</div>
			{/if}
			{if $field_name eq 'city'}
				<div class="control-row {if isset($errors.city)}error{/if}">
					<div class="control-label"><label for="city">{l s='City'} <sup>*</sup></label></div>
					<div class="control-widget">
			...
			{if $field_name eq 'Country:name' || $field_name eq 'country'}
				<div class="control-row  {if isset($errors.country_address)}error{/if}">
					<div class="control-label"><label for="id_country">{l s='Country'}<sup>*</sup></label></div>
					<div class="control-widget">
			...
			{if $field_name eq 'phone'}
				...
				<div class="control-row  {if isset($errors.phone)}error{/if}">
					<div class="control-label"><label for="phone">{l s='Home phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label></div>
					<div class="control-widget">
						...
						{if isset($errors.phone)}<div class="signature">{$errors.phone}</div>{/if}
					</div>
					<div class="gk-clear-fix"></div>
				</div>
			{/if}
			{if $field_name eq 'phone_mobile'}
				...
				<div class="control-row  {if isset($errors.phone_mobile)}error{/if}">
					<div class="control-label"><label for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label></div>
					<div class="control-widget">
						...
						{if isset($errors.phone_mobile)}<div class="signature">{$errors.phone_mobile}</div>{/if}
					</div>
					<div class="gk-clear-fix"></div>
				</div>
			{/if}
		...
		<div class="control-row">
			<div class="control-label"><label for="other">{l s='Additional information'}</label></div>
			<div class="control-widget">
		...
		{/if}
		<div class="control-row {if isset($errors.alias)}error{/if}">
			<div class="control-label"><label for="alias">Название адреса</label></div>
			<div class="control-widget">
				<input type="text" id="alias" name="alias" value="{if isset($smarty.post.alias)}{$smarty.post.alias}{else if isset($address->alias)}{$address->alias|escape:'html':'UTF-8'}{elseif !$select_address}{l s='My address'}{/if}" />
				{if isset($errors.alias)}<div class="signature">{$errors.alias}</div>{/if}
				<div class="signature">{l s='Please assign an address title for future reference.'}</div>
			</div>
			<div class="gk-clear-fix"></div>
		</div>
		<p class="submit2">
