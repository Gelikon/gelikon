	...
	{if $smarty.const._PS_VERSION_ >= 1.6}
        ...
        <div class="control-row radio">
                <div class="control-widget">
                        <input type="radio" name="payment_option" id="delivery_option_paypal" value="paypal" rel="$('#paypal_form').submit();">
                        <label for="delivery_option_paypal">
...
<form style="display: none" {if $payment_hss_solution == $smarty.const.PAYPAL_HSS_IFRAME}target="hss_iframe"{/if} id="paypal_payment_form" name="paypal_form" method="post" action="{$action_url|escape:'htmlall':'UTF-8'}">
