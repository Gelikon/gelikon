...
<div class="gk-col">
{/if}
<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" style="text-decoration:none" rel="nofollow">
	<div class="gk-cart">
		
			{*l s='Cart' mod='blockcart'*}
			<span class="num" style="position: relative;top:6px;">{$cart_qties}</span>
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="layer_cart_row">
					<strong class="dark">
						...
						{l s='Without' mod='blockcart'} <a href="?id_cms=9&controller=cms" target="_blank">{l s='shipping costs' mod='blockcart'}</a>
					</strong>
					<!--
