<!-- Block user information module NAV  -->
 <div class="gk-col">
            ...
            <div class="hide-panel">
                <form method="post" id="create-account_form_nav" action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}">
                    ...
                    <div class="control-row">
                        ...
                        <div class="control-widget">
                            <input type="text" name="email_create" id="email_create_nav"/>
                        </div>
                    ...
                    <div class="control-row">
                        ...
                        <div class="control-widget">
                            <input type="password" id="password_nav"  name="passwd"/>
                        </div>
                        <div class="gk-clear-fix"></div>
                    </div>

                    <button type="submit" class="btn btn-yellow" id="SubmitLogin" name="SubmitLogin">{l s='войти' mod='blockuserinfo'}</button>
                    <a class="btn btn-black" href="#" id="SubmitCreate" name="SubmitCreate">{l s='регистрация' mod='blockuserinfo'}</a>
