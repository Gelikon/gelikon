        ...
        <div class="gk-user-authentication">
            ...
            {/if}
             ...
             <div class="hide-panel">
                <form method="post" id="create-account_form_nav_min" action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}">
                    ...
                    <div class="control-row">
                        ...
                        <div class="control-widget">
                            <input type="text" name="email_create" id="email_create_nav_min"/>
                        </div>
                    ...
                    <div class="control-row">
                        ...
                        <div class="control-widget">
                            <input type="password" id="password_nav_min"  name="passwd"/>
                        </div>
                        <div class="gk-clear-fix"></div>
                    </div>

                    <button type="submit" class="btn btn-yellow" id="SubmitLogin" name="SubmitLogin">{l s='войти' mod='blockuserinfo'}</button>
                    <a  class="btn btn-black"  href="#" id="SubmitCreateMin" name="SubmitCreate">{l s='регистрация' mod='blockuserinfo'}</a>
                    {*}<button type="submit" class="btn btn-black" id="SubmitCreateMin" name="SubmitCreate">{l s='регистрация' mod='blockuserinfo'}</button>{*}
