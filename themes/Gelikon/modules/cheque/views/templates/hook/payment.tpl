...
<div class="control-row radio">
        <div class="control-widget">
                <input type="radio" name="payment_option" id="delivery_option_cheque" value="{$link->getModuleLink('cheque', 'payment', [], true)|escape:'html':'UTF-8'}">
                <label for="delivery_option_cheque">
