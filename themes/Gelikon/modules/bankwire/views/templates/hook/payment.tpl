...
<div class="control-row radio">
        <div class="control-widget">
                <input type="radio" name="payment_option" id="delivery_option_bankwire" value="{$link->getModuleLink('bankwire', 'payment')|escape:'html':'UTF-8'}" checked="checked">
                <label for="delivery_option_bankwire">
