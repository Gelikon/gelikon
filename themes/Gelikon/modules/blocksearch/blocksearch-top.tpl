                    ...
                    <div class="control-row">
                        <div class="control-widget">
                            <div class="icon icon-keyboard"></div>
								...
								<input class="search-input" type="text" id="search_query_top" name="search_query" placeholder="{l s='Search' mod='blocksearch'}" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
						</div>
                    </div>
                    <div class="control-row">
                        <div class="control-widget">
