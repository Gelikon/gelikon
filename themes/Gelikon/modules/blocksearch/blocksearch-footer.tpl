    ...
    <div class="gk-col gk-col4">
        <div class="gk-borders">
            <form class="gk-search-form">
                ...
                <a  href="#" class="btn-search btn-open">{l s='найти' mod='blocksearch'}</a>
			...
			<form id="searchbox" method="get" action="{$link->getPageLink('search')|escape:'html':'UTF-8'}" >
                        <div class="gk-borders">
                            <div class="control-row">
								...
								<input autofocus class="search-input" type="text" id="search_query_footer" name="search_query" placeholder="{l s='Search' mod='blocksearch'}" value="{$search_query|escape:'htmlall':'UTF-8'|stripslashes}" />
                                </div>
                            </div>
                            <div class="control-row">
                                <div class="control-widget">
