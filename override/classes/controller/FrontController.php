...
//                    die();
                ...
                if(isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' && isset($_GET['translit'])){
...
//                
////                die('223');
//                echo $f = $_SERVER['DOCUMENT_ROOT']._PS_JS_DIR_.'jquery/plugins/arcticmodal/jquery.arcticmodal-0.3.min.js';
//                echo file_exists($f);
//                die();
//                $this->addJS($_SERVER['DOCUMENT_ROOT']._PS_JS_DIR_.'jquery/plugins/arcticmodal/jquery.arcticmodal-0.3.min.js');
//                $this->addCSS($_SERVER['DOCUMENT_ROOT']._PS_JS_DIR_.'jquery/plugins/arcticmodal/jjquery.arcticmodal-0.3.css');
        ...
        public function postProcess() {
            ...
            if(Tools::isSubmit('feedbackSubmit')){
                ...
                $templateVars = array(
                    '{email}' => Tools::getValue('feedback_email'),
                    '{name}' => Tools::getValue('feedback_name'),
                    '{mess}' => Tools::getValue('feedback_mess')
